...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("donate")
        .setDescription("Adiciona fichas à conta de outro usuário (apenas para administradores).")
    ...
    async execute(interaction) {
        ...
        try {
            ...
            return interaction.reply(`✅ **${quantia} fichas** foram adicionadas para <@${destinatarioId}>.`);
        } catch (error) {
