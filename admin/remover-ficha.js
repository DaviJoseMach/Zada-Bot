...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("remover-fichas")
        .setDescription("Remove fichas à conta de outro usuário (apenas para administradores).")
    ...
    async execute(interaction) {
        ...
        try {
            ...
            return interaction.reply(`✅ **${quantia} fichas** foram removidas de <@${destinatarioId}>.`);
        } catch (error) {
