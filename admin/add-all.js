...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("add-all")
        .setDescription("Adicione fichas a todos os players do cassino (Apenas administradores)")
    ...
    async execute(interaction) {
        ...
        try {
            ...
            return interaction.reply(`<a:saldo:1320913551623196685>  Fichas adicionadas! Cada usuário recebeu **${quantia}** fichas.`);
        } catch (error) {
            console.error(error);
